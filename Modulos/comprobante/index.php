        ...
        if(isset($_POST["id"])){
            ...
            if($id==0){
                ...
                if($conn === false) {
                    ...
                    $sql = "SELECT count(id) as total FROM vst_comprobante WHERE comprobante = '".$comprobante."'";
                    $stmt = sqlsrv_query($conn, $sql);
                    
                    while( $row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                        if($row['total']==0){
                            $sql2 = "INSERT INTO tb_comprobante (comprobante_descripcion, comprobante_estado)
                            VALUES ('".$comprobante."', 1)";
                            ...
                            if( $stmt2 == false ) {
                                ...
                                echo mensajes('El comprobante ha sido Registrado con Exito','verde');
                            }
                        }else{
                            echo mensajes('El comprobante ya ha sido registrado.','rojo');
                        }
                    }
                }
            }else{
                ...
                $sql2 = "UPDATE tb_comprobante SET comprobante_descripcion = '".$comprobante."', comprobante_estado = ".$estado." WHERE id_comprobante = ".$id;
                ...
                if( $stmt2 == false ) {
                    ...
                    echo mensajes('El comprobante ha sido Actualizado con Exito','verde');
                }    
            }
        }
    ?>
                                    ...
                                    <div class="span6">
                                        <form name="form1" method="post" action="">
                                            <div class="input-append">
                                                <input type="text" name="buscar" class="input-xlarge" autocomplete="off" autofocus placeholder="Buscar Comprobantes">
                                        ...
                                        <strong><i class="icon-plus"></i> Nuevo Comprobante</strong>
                                        </a>
                                        ...
                                        <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <form name="form2" method="post" action="">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 id="myModalLabel">Nuevo Comprobante</h3>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row-fluid">
                                                        <div class="span6">
                                                            ...
                                                            <input type="text" name="comprobante" autocomplete="off" required value=""  tabindex="100"><br>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <td>
            	   <table class="table table-bordered table">
                        <tr class="info" style="background-color: #ea421c;">
                            ...
                            <td><strong class="text-info">comprobante</strong></td>
                        ...
                        <?php
                            ...
                            if(!empty($_POST['buscar'])){
                                ...
                                $sql="SELECT * FROM vst_comprobante WHERE comprobante LIKE '%$buscar%' ORDER BY comprobante ASC";
                            }else{
                                $sql="SELECT * FROM vst_comprobante ORDER BY comprobante ASC";
                            }
                        ...
                        ?>
                            ...
                            <td>
                                <center>
                                    <a href="#a<?php echo $row['id']; ?>" title="Editar comprobante" role="button" class="btn btn-mini" data-toggle="modal">
                                        <i class="icon-edit"></i>
                                    </a>
                                </center>
                                    ...
                                    <form name="form3" method="post" action="">
                                        ...
                                        <div class="modal-body">
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <strong>comprobante</strong><br>
                                                    <input type="text" name="comprobante" autocomplete="off" required value="<?php echo $row['comprobante']; ?>" tabindex="100"><br>
                                                </div>
                                                <div class="span6">
