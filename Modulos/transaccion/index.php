...
<html lang="es">
    ...
    <?php
        if(isset($_POST["id"])){
            $id=limpiar($_POST['id']);
            $transaccion=limpiar($_POST['transaccion']);
            ...
            if($id==0){
                ...
                $sql = "sp_transaccion ?, ?, ?, ?, ?";
                $stmt = sqlsrv_query($conn, $sql, array(1, $id, $tipo, $transaccion, 1));
                
                if( $stmt == false ) {
                    echo mensajes('Hubo un error al registrar los datos.','rojo');
                }else{
                    echo mensajes('Los datos del tipo e tranacción "'.$transaccion.'" Ha sido Registrado con Exito','verde');
                }
            }else{
                ...
                $sql = "sp_transaccion ?, ?, ?, ?, ?";
                $stmt = sqlsrv_query($conn, $sql, array(2, $id, $tipo, $transaccion, $estado));
                
                if( $stmt == false ) {
                    echo mensajes('Hubo un error al actualizar los datos.','rojo');
                }else{
                    echo mensajes('Los dato del tipo e tranacción "'.$transaccion.'" Ha sido Actualizado con Exito','verde');
                }    
            }
        }
    ?>
                        ...
                        <tr class="info" style="background-color: #ff8600;">
                            <td>
                                <div class="row-fluid">
                                    <div class="span6">
                                        <h2 class="text-info">
                                            <img src="../../img/alertas.png" width="80" height="80">
                                            Transacciones
                                        </h2>
                                    </div>
                                    <div class="span6">
                                        <form name="form1" method="post" action="">
                                            <div class="input-append">
                                                <input type="text" name="buscar" class="input-xlarge" autocomplete="off" autofocus placeholder="Buscar Transacciones">
                                        ...
                                        <strong><i class="icon-plus"></i> Nueva Transacción</strong>
                                        </a>
                                        ...
                                        <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <form name="form2" method="post" action="">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 id="myModalLabel">Nueva Transacción</h3>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="span6">
                                                            ...
                                                            <input type="text" name="transaccion" autocomplete="off" required tabindex="100"><br>
                                                        </div>
                                                    </div>
                                                </div>
            	   ...
            	   <table class="table table-bordered table">
                        ...
                        <?php
                            ...
                            if(!empty($_POST['buscar'])){
                                ...
                                $sql="SELECT * FROM vst_transaccion WHERE transaccion LIKE '%$buscar%'";					
                            }else{
                                $sql="SELECT * FROM vst_transaccion";				
                            }
                        ...
                        ?>
                            ...
                            <td>
                                <center>
                                    <a href="#a<?php echo $row['id']; ?>" title="Editar Transacción" role="button" class="btn btn-mini" data-toggle="modal">
                                        <i class="icon-edit"></i>
                                    </a>
                                </center>
                                <div id="a<?php echo $row['id']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <form name="form3" method="post" action="">
                                        ...
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            <h3 id="myModalLabel">Actualizar Transacción</h3>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <strong>Tipo</strong><br>
                                                    <select name="tipo" tabindex="100">
                                                        <option value="Ingreso" <?php if($row['tipo']==1){ echo 'selected'; } ?>>Ingreso</option>
                                                        <option value="Egreso" <?php if($row['tipo']==0){ echo 'selected'; } ?>>Egreso</option>
                                                    </select>
                                                ...
                                                <div class="span6">
                                                    <strong>Transacción</strong><br>
                                                    <input type="text" name="transaccion" autocomplete="off" required value="<?php echo utf8_encode($row['transaccion']); ?>" tabindex="100"><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
