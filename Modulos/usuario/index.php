    ...
    <?php
        if(isset($_POST["id"])){
            ...
            if($id==0){
                ...
                $connectionInfo = array( "Database"=>"BD_TESORERIA", "UID"=>"sa", "PWD"=>"17*profair");
                $conn = sqlsrv_connect( $serverName, $connectionInfo);
                
                $stmt = sqlsrv_query($conn,"INSERT INTO tb_personal (personal_nombres, personal_paterno, personal_materno, id_perfil, personal_usuario, personal_contrasena, personal_genero, personal_email, personal_estado) VALUES ('".$nombre."', '".$paterno."', '".$materno."', ".$tipo.", '".$usuario."', '".$contrasena."', '".$genero."', '".$email."', 1)");
                
                if( $stmt == false ) {
                    echo mensajes('Hubo un error al registrar los datos.','rojo');
                }else{
                    echo mensajes('Los datos del usuario "'.$nombre.' '.$paterno.'" Ha sido Registrado con Exito','verde');
                }
            }else{
                if(!empty($_POST['idtipo'])){
                    $tipo=limpiar($_POST['tipo']);
                }else{
                    $tipo=limpiar($_POST['idtipo']);
                }
                ...
                $stmt = sqlsrv_query($conn, "UPDATE tb_personal SET personal_nombres = '".$nombre."', personal_paterno = '".$paterno."', personal_materno = '".$materno."', id_perfil = ".$tipo.", personal_usuario = '".$usuario."', personal_contrasena = '".$contrasena."', personal_genero = '".$genero."', personal_email = '".$email."', personal_estado = ".$estado." WHERE id_personal = ".$id);
                
                if( $stmt == false ) {
                    echo mensajes('Hubo un error al actualizar los datos.','rojo');
                }else{
                    echo mensajes('Los datos del usuario "'.$nombre.' '.$paterno.'" Ha sido Actualizado con Exito','verde');
                }    
            }
        }
    ?>
                    ...
                    <table class="table table-bordered">
                        <tr class="info" style="background-color: #ff8600;">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <h2 class="text-info">
                                    <img src="../../img/usuario.png" width="80" height="80">
                                    Usuarios
                                    </h2>
                                </div>
                                <div class="span6">
                                            ...
                                            <div class="modal-body">
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        ...
                                                        <input type="text" name="nombre" autocomplete="off" required value=""  tabindex="100"><br>
                                                        <strong>Ap. Materno</strong><br>
                                                        <input type="text" name="materno" autocomplete="off" required value="" tabindex="102"><br>
                                                        <strong>Tipo de Usuario</strong><br>
                                                        <select name="tipo" tabindex="104">
                                                            <?php
                                                                $serverName = "192.168.1.100";
                                                                $connectionInfo = array( "Database"=>"BD_TESORERIA", "UID"=>"sa", "PWD"=>"17*profair");
                                                                $conn = sqlsrv_connect( $serverName, $connectionInfo);
                                                        ...
                                                        <input type="text" name="usuario" autocomplete="off" required value="" tabindex="106"><br>
                                                    </div>
                                                    <div class="span6">
                                                        <strong>Ap. Paterno</strong><br>
                                                        <input type="text" name="paterno" autocomplete="off" required value="" tabindex="101"><br>
                                                        <strong>Género</strong><br>
                                                        <select name="genero" tabindex="103">
                                                            <option value="M">Masculino</option>
                                                            <option value="F">Femenino</option>
                                                        </select>
                                                        <strong>Correo</strong><br>
                                                        <input type="email" name="email" autocomplete="off" value="" tabindex="105"><br>
                                                        <strong>Contraseña</strong><br>
                                                        <input type="text" name="contrasena" autocomplete="off" required value="" tabindex="107"><br>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <td>
            	   <table class="table table-bordered table">
                        <tr class="info" style="background-color: #ea421c;">
                            ...
                            <td><strong class="text-info">Género</strong></td>
                            <td><strong class="text-info">Nombre y Apellidos</strong></td>
                        ...
                        <?php
                            ...
                            if(!empty($_POST['buscar'])){
                                ...
                                $sql="SELECT * FROM vst_usuario WHERE nombres LIKE '%$buscar%' or paterno LIKE '%$buscar%' or materno='$buscar' ORDER BY nombres ASC";					
                            }else{
                                $sql="SELECT * FROM vst_usuario ORDER BY nombres ASC";				
                            }
                                ...
                                <div id="a<?php echo $row['id']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <form name="form3" method="post" action="">
                                        ...
                                        <div class="modal-body">
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <strong>Nombre del Personal</strong><br>
                                                    <input type="text" name="nombre" autocomplete="off" required value="<?php echo $row['nombres']; ?>" tabindex="100"><br>
                                                    <strong>Ap. Materno</strong><br>
                                                    <input type="text" name="materno" autocomplete="off" required value="<?php echo $row['materno']; ?>" tabindex="102"><br>
                                                    <strong>Tipo de Usuario</strong><br>
                                                    <select name="tipo" tabindex="104">
                                                        <?php
                                                            $sql2 = "SELECT * FROM vst_perfil WHERE estado = 1 ORDER BY perfil ASC";
                                                            $stmt2 = sqlsrv_query($conn, $sql2);
                                                            
                                                            while($row2 = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC)) {
                                                                if($row['dperfil']==$row2['perfil']){
                                                        ?>
                                                                    <option value=<?php echo $row2['id']; ?> selected><?php echo $row2['perfil']; ?></option>
                                                                    <input type="text" name="idtipo" value=<?php echo $row2['perfil']; ?>>
                                                        <?php
                                                                }else{
                                                        ?>
                                                                    <option value=<?php echo $row2['id']; ?> ><?php echo $row2['perfil']; ?></option>
                                                        <?php
                                                                }
                                                            }
                                                    ...
                                                    <strong>Usuario</strong><br>
                                                    <input type="text" name="usuario" autocomplete="off" required value="<?php echo $row['usuario']; ?>" tabindex="106"><br>
                                                ...
                                                <div class="span6">
                                                    <strong>Ap. Paterno</strong><br>
                                                    <input type="text" name="paterno" autocomplete="off" required value="<?php echo $row['paterno']; ?>" tabindex="101"><br>
                                                    <strong>Género</strong><br>
                                                    <select name="genero" tabindex="103">
                                                    ...
                                                    <strong>Correo</strong><br>
                                                    <input type="email" name="email" autocomplete="off" value="<?php echo $row['email']; ?>" tabindex="105"><br>
                                                    <strong>Contraseña</strong><br>
                                                    <input type="text" name="contrasena" autocomplete="off" required value="<?php echo $row['contrasena']; ?>" tabindex="107"><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
